/*CRIA O BANCO DE DADOS COM O NOME DE 'CRUD'*/
CREATE DATABASE IF NOT EXISTS `crud` CHARACTER SET utf8;

/*CRIA UMA TABELA NO BANCO CRUD COM O NOME DE 'USERS'*/
...
/*CRIA UMA TABELA NO BANCO DE DADOS CRUD COM O NOME DE 'NOTICIAS'*/
CREATE TABLE IF NOT EXISTS `crud`.`noticias` (
...
/*INSERE UM USUÁRIO PADRÃO NO BANCO DE DADOS CRUD*/
